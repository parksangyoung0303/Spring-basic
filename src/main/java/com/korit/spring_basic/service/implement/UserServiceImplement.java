...
public class UserServiceImplement implements UserService {
    ...
    public ResponseEntity<ResponseDto> postUser(PostUserRequestDto dto) {
        ...
        try {
            ...
            boolean isxistUserTelNumber = userRepository.existsByUserTelNumber(userTelNumber);
            if (isxistUserTelNumber) return ResponseDto.duplicatedTelNumber();

            // UserEntity userEntity = 
            // new UserEntity(userId, dto.getUserPassword(), dto.getUserName(), dto.getUserAddress(), userTelNumber);
